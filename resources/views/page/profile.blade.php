                ...
                <main class="content">
                    <div class="container p-0">
                        ...
                        <div class="mb-3 d-flex justify-content-between">
                            <a href="{{ url('/') }}" class="btn btn-primary ps-2">
                                <span>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('/petugas/updatePic/' . $data->id) }}" method="post"
                                            ...
                                            <Input class="" name="pic" type="file" id="image"
                                                onchange="previewImage()" />
                                            <button class="float-end btn btn-primary btn-sm mt-2" type="submit">Ganti
                                                Foto</button>
                                        </form>
                                        ...
                                        <div class="modal modal-alert fade" data-bs-backdrop="static" tabindex="-1"
                                            role="dialog" id="hapus" style="margin-top: 100px;">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content rounded-3 shadow w-75 m-auto"
                                                    ...
                                                    <form action="{{ url('petugas/deletePic/' . $data->id) }}"
                                                        method="post">
                                                        @csrf
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body pt-0">
                                        <form action="{{ url('/petugas/update/' . $data->id) }}" method="POST">
                                            ...
                                            <label @if (auth()->user()->role != 'Admin') class="d-none" @endif>Posisi</label>
                                            <div class="input-group mb-3 @if (auth()->user()->role != 'Admin') d-none @endif">
                                                <span class="input-group-text" id="basic-addon1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                        height="16" fill="currentColor" class="bi bi-person-fill"
                                                        viewBox="0 0 16 16">
                                                ...
                                                <select class="form-select" name="role" required>
                                                    <option value="Admin"
                                                        @if ($data->role == 'Admin') {{ 'selected' }} @endif>
                                                        Admin
                                                    </option>
                                                    <option value="Petugas"
                                                        @if ($data->role == 'Petugas') {{ 'selected' }} @endif>
                                                        Petugas
                                                    </option>
                                                </select>
                                            </div>
                                            <button class="float-end btn btn-primary btn-sm mt-2" type="submit">Ubah
                                                Profil</button>
                                        </form>
                                    </div>
                                </div>
